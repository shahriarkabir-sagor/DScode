...
public class MyDialogDecimalFragment extends DialogFragment {
    ...
    public MyDialogDecimalFragment() {
        RequestCode = -1;
    ...
    public MyDialogDecimalFragment(Context context, int requestCode) {
        Context = context;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        dialogView = inflater.inflate(R.layout.layout_one_et_decimal,null);
        edt = dialogView.findViewById(R.id.oneEtdecimalId);
    ...
    public interface DialogPositiveListener{
        void onPositiveListen(int requestCode, float value);
    }
...
/*
LayoutInflater inflater = getActivity().getLayoutInflater();
        View decimalView = inflater.inflate(R.layout.layout_one_et_decimal,null);
		edt = decimalView.findViewById(R.id.oneEtdecimalId);
*/
